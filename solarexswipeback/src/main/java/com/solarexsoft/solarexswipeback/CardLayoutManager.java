...
public class CardLayoutManager extends RecyclerView.LayoutManager {
    ...
    public void onLayoutChildren(RecyclerView.Recycler recycler, RecyclerView.State state) {
        ...
        if (itemCount > CardConfig.DEFAULT_SHOW_ITEMS) {
            // 数据源个数大于最大显示数时
            for (int position = CardConfig.DEFAULT_SHOW_ITEMS; position >= 0; position--) {
                ...
                if (position == CardConfig.DEFAULT_SHOW_ITEMS) {
